...
const renderJobs = (arrayObjetJobs) => {
    containerJobs.innerHTML = "";
  arrayObjetJobs.map((job) => {
    const html = `
    <section class="card">
        <div class="column-1">
...
const  newJobs = jobs.filter(
    (job) => job.languages.includes(techFilter) || job.tools.includes(techFilter)
);
//? como la funcion renderJobs recibe como parametro un arraydeObetos
